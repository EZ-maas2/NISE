...
uint8_t dxl_new_id = DXL_NEW_ID; // MOTOR NEW ID?
...
String a;
  ...
  {
  dxl_comm_result = packetHandler->write1ByteTxRx(portHandler, id, ADDR_AX_ID, dxl_new_id, &dxl_error); // set motor old id 
  delay(10);
  }
}
